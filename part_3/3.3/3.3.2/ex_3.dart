...
void main() async {
  ...
  // Транзакция с исключением (автоматический откат)
  try {
    await runGradingTransaction(
      ...
      () async {
        await service.assignGrade(student1, 95);
        await service.assignGrade(student2, 88);

        // Имитируем ошибку системы
        throw Exception('Сбой в системе оценок');
      },
      service,
    );
  } catch (e) {
